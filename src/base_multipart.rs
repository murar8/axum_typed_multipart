use crate::{StatefulTryFromMultipart, TypedMultipartError};
...
/// [TryFromMultipart](crate::TryFromMultipart) trait and the generic rejection implements the
